...
export function Hero() {
  ...
  const line2 = 'that inspire living.'
  ...
  return (
    <section ref={ref} id="top" className="relative h-[100svh] min-h-[640px] overflow-hidden">
      <motion.div style={{ y: imageY, scale: imageScale }} className="absolute inset-0">
        <img
          src="/images/hero.png"
          alt="Luxury modern interior designed by Absolute Creation"
      ...
      >
        ...
        >
          ...
          <span className="text-xs font-semibold uppercase tracking-[0.3em] text-background/90">
            Interior · Fit-Out · Architecture
          </span>
        </motion.div>
          ...
          {[line1, line2].map((line, li) => (
            <span key={li} className="block overflow-hidden">
              <motion.span
                ...
                initial={{ y: '110%' }}
                animate={{ y: 0 }}
                transition={{ delay: 1.4 + li * 0.15, duration: 0.9, ease: easeOut }}
              >
                {line}
              </motion.span>
            </span>
        ...
        <motion.p
          ...
          className="mt-8 max-w-xl text-pretty text-base leading-relaxed text-background/85 md:text-lg"
        >
          Absolute Creation delivers end-to-end design and construction for the world&apos;s most
          discerning residential and commercial clients — where architecture, craft and detail meet.
        </motion.p>
      ...
      <motion.a
        ...
        className="absolute bottom-8 left-1/2 z-10 flex -translate-x-1/2 flex-col items-center gap-2 text-background/70"
      >
