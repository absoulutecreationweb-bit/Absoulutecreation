        ...
        <div className="grid gap-12 lg:grid-cols-[1.15fr_0.75fr_1.45fr_1.2fr] lg:gap-10">
          ...
          <div>
            ...
            <div className="mt-6 space-y-4 text-sm text-muted-foreground">
              ...
              <a href="mailto:siva@theabsolutecreation.com" className="flex items-center gap-3 hover:text-foreground"><Mail className="size-4 shrink-0" />siva@theabsolutecreation.com</a>
            </div>
          </div>
